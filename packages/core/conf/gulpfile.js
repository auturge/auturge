...
const engines = require(PACKAGE_JSON_PATH).engines;
...
const GULP_SCRIPTS_FOLDER = path.resolve(SCRIPTS_FOLDER, "./gulp");

// See `scripts/gulp-tasks/README.md` for information about task loading.
const GULP_TASKS_FOLDER = path.resolve(GULP_SCRIPTS_FOLDER, "./gulp-tasks");

function loadTask(fileName, taskName) {
    const modulePath = path.resolve(GULP_TASKS_FOLDER, fileName);
